...
function corporateclean_breadcrumb($variables){
  ...
  $breadcrumb_separator=theme_get_setting('breadcrumb_separator','Diggie');
...
function corporateclean_page_alter($page) {
	...
	if (theme_get_setting('responsive_meta','Diggie')):
...
function corporateclean_preprocess_html(&$variables) {
	...
	if (!theme_get_setting('responsive_respond','Diggie')):
 ...
 */
if (theme_get_setting('slideshow_js','Diggie')):

	drupal_add_js(drupal_get_path('theme', 'Diggie') . '/js/jquery.cycle.all.js');
	
	//Initialize slideshow using theme settings
	$effect=theme_get_setting('slideshow_effect','Diggie');
	$effect_time=theme_get_setting('slideshow_effect_time','Diggie')*1000;
	$slideshow_randomize=theme_get_setting('slideshow_randomize','Diggie');
	$slideshow_wrap=theme_get_setting('slideshow_wrap','Diggie');
	$slideshow_pause=theme_get_setting('slideshow_pause','Diggie');
