...
<div id="banner">
    ...
    <?php if (theme_get_setting('slideshow_display','Diggie')): ?>
    ...
    <div id="slideshow">
        ...
        <div class="slider-item">
            <div class="content container_12">
                ...
                <img class="masked" src="<?php print base_path() . drupal_get_path('theme', 'Diggie') ;?>/mockup/slide-1.jpg" style="height:268px"/>
                </div>
        ...
        <div class="slider-item">
            <div class="content container_12">
                ...
                <img class="masked" src="<?php print base_path() . drupal_get_path('theme', 'Diggie') ;?>/mockup/slide-2.jpg" style="height:168px;"/>
                </div>
        ...
        <div class="slider-item">
            <div class="content container_12">
            	<div class="grid_12">
                <div style=" padding:0 0 0 00px;">
                <img class="masked" src="<?php print base_path() . drupal_get_path('theme', 'Diggie') ;?>/mockup/slide-3.jpg" style="height:168px;float:left;"/>
                </div>
                <!--slider-item content-->
                <h2>Jeugdverblijf</h2>
        ...
        <div class="slider-item">
            <div class="content container_12">
            	<div class="grid_12">
                <div style=" padding:0 0 0 00px;">
                <img class="masked" src="<?php print base_path() . drupal_get_path('theme', 'Diggie') ;?>/mockup/slide-4.jpg" style="height:168px;float:left;"/>
                </div>
                <!--slider-item content-->
...
<div id="content">
    ...
    <div id="content-inside" class="container_12 clearfix">
        ...
        <?php } ?>
            ...
            <?php if (theme_get_setting('breadcrumb_display','Diggie')): print $breadcrumb; endif; ?>
